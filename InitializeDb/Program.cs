...
static void InsertarDatosPrueba(ServiceProvider services, ILogger logger) {
    ...
    try {
        ...
        long atornilladorId = materialCEN.Crear("Atornillador eléctrico", "Atornillador inalámbrico 12V con dos baterías.", Estado, C, "/Images/Atornillador eléctrico.jpg");
        long lijadoraId = materialCEN.Crear("Lijadora orbital", "Lijadora orbital de mano, incluye lijas de varios grosores.", EnMantenimiento, C, "/Images/Lijadora orbital.jpg");
        long pistolaCalorId = materialCEN.Crear("Pistola de calor", "Pistola de aire caliente regulable, útil para termorretráctil.", Estado, C, "/Images/pistola-calor-003.jpg");

        C = ApplicationCore.Domain.Enums.CategoriaMaterial.Electronica;
        long multimetroId = materialCEN.Crear("Multímetro digital", "Multímetro de mano con medición de voltaje, corriente y continuidad.", Estado, C, "/Images/Multímetro digital.jpg");
        long osciloscopioId = materialCEN.Crear("Osciloscopio", "Osciloscopio digital de 2 canales, 100MHz.", Estado, C, "/Images/Osciloscopio.jpg");
        long estacionSoldaduraId = materialCEN.Crear("Estación de soldadura", "Estación de soldadura con temperatura regulable y soporte.", Estado, C, "/Images/Estación de soldadura.jpg");
        long fuenteAlimentacionId = materialCEN.Crear("Fuente de alimentación", "Fuente de alimentación de laboratorio, 0-30V regulable.", Estado, C, "/Images/Fuente de alimentación.jpg");
        long arduinoKitId = materialCEN.Crear("Kit de Arduino", "Kit de iniciación con placa Arduino Uno, cables y sensores básicos.", Estado, C, "/Images/Kit de Arduino.jpg");
        ...
        long impresoraResinaId = materialCEN.Crear("Impresora 3D de resina", "Impresora de resina para piezas de alto detalle.", Estado, C, "/Images/Impresora 3D de resina.png");
        long cortadoraLaserId = materialCEN.Crear("Cortadora láser", "Cortadora/grabadora láser de sobremesa, área de trabajo A3.", Roto, C, "/Images/Cortadora láser.jpg");
        long cncId = materialCEN.Crear("CNC de sobremesa", "Fresadora CNC de 3 ejes para madera y plásticos blandos.", Estado, C, "/Images/CNC de sobremesa.jpg");
        long escaner3dId = materialCEN.Crear("Escáner 3D", "Escáner 3D de mano para digitalizar objetos pequeños.", Estado, C, "/Images/Escáner 3D.jpg");

        C = ApplicationCore.Domain.Enums.CategoriaMaterial.Costura;
        long maquinaCoserId = materialCEN.Crear("Máquina de coser", "Máquina de coser doméstica con varios tipos de puntada.", Estado, C, "/Images/Máquina de coser.jpg");
        long overlockId = materialCEN.Crear("Máquina overlock", "Máquina overlock para rematar y coser telas elásticas.", Estado, C, "/Images/Máquina overlock.jpg");
        long planchaId = materialCEN.Crear("Plancha industrial", "Plancha de vapor de uso intensivo para taller de costura.", Estado, C, "/Images/Plancha industrial.jpg");
        long patronajeId = materialCEN.Crear("Kit de patronaje", "Reglas, escuadras y papel de patronaje para confección.", Estado, C, "/Images/Kit de patronaje.jpg");

        C = ApplicationCore.Domain.Enums.CategoriaMaterial.Carpinteria;
        long sierraCalarId = materialCEN.Crear("Sierra de calar", "Sierra de calar eléctrica con hojas de varios tipos.", Estado, C, "/Images/Sierra de calar.jpg");
        long routerId = materialCEN.Crear("Router de carpintero", "Fresadora de mano para trabajos de carpintería.", Estado, C, "/Images/Router de carpintero.jpg");
        long cepilloId = materialCEN.Crear("Cepillo eléctrico", "Cepillo eléctrico para desbastar madera.", EnMantenimiento, C, "/Images/Cepillo eléctrico.jpg");
        long prensaBancoId = materialCEN.Crear("Prensa de banco", "Prensa de banco robusta para sujeción de piezas.", Estado, C, "/Images/Prensa de banco.jpg");

        C = ApplicationCore.Domain.Enums.CategoriaMaterial.Informatica;
        long portatilId = materialCEN.Crear("Portátil de préstamo", "Portátil configurado con software de diseño y CAD.", Estado, C, "/Images/Portátil de préstamo.jpg");
        long tabletGraficaId = materialCEN.Crear("Tablet gráfica", "Tableta gráfica con lápiz para diseño digital.", Estado, C, "/Images/Tablet gráfica.jpg");
        long camaraId = materialCEN.Crear("Cámara réflex", "Cámara réflex digital con objetivo estándar 18-55mm.", Estado, C, "/Images/Cámara réflex.jpg");
        long tripodeId = materialCEN.Crear("Trípode profesional", "Trípode de aluminio, altura regulable hasta 1.6m.", Estado, C, "/Images/Trípode profesional.jpg");
        long proyectorId = materialCEN.Crear("Proyector portátil", "Proyector portátil HD con entrada HDMI y USB.", Estado, C, "/Images/Proyector portátil.jpg");

        C = ApplicationCore.Domain.Enums.CategoriaMaterial.Otros;
        long generadorId = materialCEN.Crear("Generador eléctrico", "Generador eléctrico portátil a gasolina, 2000W.", Estado, C, "/Images/Generador eléctrico.jpg");
        long carpaId = materialCEN.Crear("Carpa plegable", "Carpa plegable 3x3m para eventos y ferias.", Estado, C, "/Images/Carpa plegable.jpg");
        ...
        materialCEN.Modificar(arduinoKitId, "Kit de Arduino", "Kit de iniciación con placa Arduino Uno, cables y sensores básicos.", Prestado, ApplicationCore.Domain.Enums.CategoriaMaterial.Electronica, "/Images/Kit de Arduino.jpg", mariaId);
        ...
        materialCEN.Modificar(maquinaCoserId, "Máquina de coser", "Máquina de coser doméstica con varios tipos de puntada.", Prestado, ApplicationCore.Domain.Enums.CategoriaMaterial.Costura, "/Images/Máquina de coser.jpg", anaId);
        materialCEN.Modificar(planchaId, "Plancha industrial", "Plancha de vapor de uso intensivo para taller de costura.", Prestado, ApplicationCore.Domain.Enums.CategoriaMaterial.Costura, "/Images/Plancha industrial.jpg", anaId);
        ...
        materialCEN.Modificar(camaraId, "Cámara réflex", "Cámara réflex digital con objetivo estándar 18-55mm.", Prestado, ApplicationCore.Domain.Enums.CategoriaMaterial.Informatica, "/Images/Cámara réflex.jpg", carlosId);
        materialCEN.Modificar(tripodeId, "Trípode profesional", "Trípode de aluminio, altura regulable hasta 1.6m.", Prestado, ApplicationCore.Domain.Enums.CategoriaMaterial.Informatica, "/Images/Trípode profesional.jpg", carlosId);
        ...
        materialCEN.Modificar(multimetroId, "Multímetro digital", "Multímetro de mano con medición de voltaje, corriente y continuidad.", Prestado, ApplicationCore.Domain.Enums.CategoriaMaterial.Electronica, "/Images/Multímetro digital.jpg", pabloId);
        ...
        materialCEN.Modificar(portatilId, "Portátil de préstamo", "Portátil configurado con software de diseño y CAD.", Prestado, ApplicationCore.Domain.Enums.CategoriaMaterial.Informatica, "/Images/Portátil de préstamo.jpg", mariaId);
        ...
        materialCEN.Modificar(altavozId, "Altavoz portátil", "Altavoz Bluetooth portátil con batería de larga duración.", Prestado, ApplicationCore.Domain.Enums.CategoriaMaterial.Otros, "/Images/04_8431543121839.webp", carlosId);
